...
Изучить и применить на практике команды для установки соединения с удаленной машиной,
для отправки команд на нее и передачи файлов и директорий.
...
Программа для виртаулизации: **VirtualBox**, версия **6.1**\
Операционная система семейства: **linux (ubuntu)**, версия **5.15.0-47-generic cosmic**\
Интерпретатор команд: **bash**, версия **5.1.16**.\
Система программирования: **--**, версия **--**\
Редактор текстов: **emacs**, версия **25.2.2**\
Утилиты операционной системы: **ssh, scp, sftp, tar, iconv**\
Прикладные системы и программы: **--**\

## 6. Идея, метод, алгоритм решения задачи

Для решения поставленной задачи я опробовал на практике команды для установки соединения с удаленной машиной. Попробовал некоторые основные команды терминала на удаленной машине.
Разными способами попробовал передать файлы и директории на удаленную машину. Попробовал
инструменты для архивации файлов.

## 7. Сценарий выполнения работы

Для тестирования команд удаленного управления я запустил две виртуальные машины с 
установленными на них операционными системами Linux, соединенных в одну виртуальную 
локальную сеть. С помощью команды `$ ifconfig` я узнал их адреса в локальной сети.
Для начала я установил соединение между двумя машинами через ssh и попробовал основные
команды терминала.
Далее я создал файл file.txt и передал его с помощью scp на другую машину. Далее я создал
директорию somedir с двумя файлами и передал ее удаленной машине.
Для практики с sftp я установил соединение sftp, отправил файл удаленной машине и принял 
файл от нее.
Далее я заархивировал папку somedir, с помощью sftp передал архив на удаленную машину и с
помощью ssh распаковал ее там.
Также я освоил работу с командой iconv, поменяв кодировку файла с КОИ-8 на Windows CP-1251.
...
Благодаря лабораторной работе я смог ознакомиться с основными командами работы с удаленной машиной в OS UNIX. Научился работать с утилитой tar для архивирования файлов и утилиту iconv для смены кодировки
файлов.
